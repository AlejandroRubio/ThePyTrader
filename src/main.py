...
from services.wallet_manager import procesado_cartera_completo, detalle_operaciones_por_accion, procesado_historico_cartera_completo
...
def mostrar_menu():
    ...
    logger.info("6. Calcular histórico de cartera")
    logger.info("0. Salir")
